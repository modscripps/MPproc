function g_pdf(filename,CurrentMFilename,CurrentDirectory)
...
%   gvoet@ucsd.edu
%
%   Last modification: 11/24/2014

% NOTE
% Bug in 2014b - eps printing does not work properly. Use direct printing
% to pdf format until bug is fixed.
...
% Test whether gpr was called from the command line
CallFromCommandLine =...
  strcmp('/Users/gunnar/Projects/matlab/toolboxes/gunnar/gpr.m',...
         CurrentMFilename);
...
dispstr = ['\caption{',cap,...
           ' \\newline \hspace{\linewidth} {\footnotesize{Created from command line.',...
           '} ',...
           datestr(now,'mm/dd/yy'),...
           '}}}'];  
else
dispstr = ['\caption{',cap,...
           ' \newline \hspace{\linewidth} {\footnotesize{Created with \clink{file://',...
           CurrentMFilename,...
           '}{',...
           cm,...
           '} ',...
