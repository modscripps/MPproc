...
%NOTE:  To suppress axes labels, enter a space as a character into the 
% appropriate axes matrix.
...
for i=1:nseries
   ...
   %create initial axis
    ...
    hold on
    set(gca,'XColor',pp.linecolor(1,:),'XTickLabel',[],'YColor',pp.linecolor(1,:))
