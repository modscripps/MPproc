...
%Take a CTD and highpass filter u, v, and etaEUL.
%The records need to be evenly sampled before calling this.
%10/09
%MHA
%Specify FP.ffilt (cpd) - the lower limit.  This will band-pass filter a
%timeseries.
