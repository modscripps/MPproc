function [aqdp] = MP_aqdp_transform(aqdp,transform)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Do coordinate transformation for Aquadopp HR velocities.
% Assuming aqdp structure made from MP_aqdp_make.m
%
...
%           disp('Doing BEAM-->ENU transformation')
        ...
        textprogressbar('Doing BEAM-->ENU transformation:    ');
        
        for whs=1:Nsamples
          
            textprogressbar(whs/Nsamples*100);
