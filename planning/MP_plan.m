...
%% Set parameters
speed=0.25; %profile speed in m/s
totaldist = 1e6; %Max m set by battery

%Settable parameters
pmin=90; %shallow pressure stop in m
pmax=1580; %deep pressure stop in m 

profile_interval = .5*3600; %profile interval in seconds
